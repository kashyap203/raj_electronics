  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden relative animate-in fade-in zoom-in duration-200">
        <button onClick={onClose} disabled={loading} className="absolute right-4 top-4 text-gray-400 hover:text-gray-700 disabled:opacity-50">
          <FaTimes size={20} />
        </button>
        ...
        <div className="p-6">
          ...
          <h3 className="text-xl font-bold text-gray-800 text-center mb-2">Verify Payment</h3>
